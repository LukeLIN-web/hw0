...
class PowerScalar(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ### BEGIN YOUR SOLUTION
        return self.scalar * power_scalar(node.inputs[0].data, self.scalar - 1) * out_grad
        ### END YOUR SOLUTION
...
class Transpose(TensorOp):
    ...
    def compute(self, a):
        ### BEGIN YOUR SOLUTION
        # return array_api.transpose(a, axes=self.axes) # test有bug
...
class Reshape(TensorOp):
    ...
    def gradient(self, out_grad, node):
        ### BEGIN YOUR SOLUTION
        res = out_grad.reshape(node.inputs[0].data.shape)
        return res
        ### END YOUR SOLUTION
